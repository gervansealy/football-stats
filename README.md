...
- **Titles Held**: Display previous season's achievements
  ...
  - Most Captain Wins
  - Highest Player Rank
- **Video Highlights**: Add and view video highlights for each player
  - Admin/Editor can add video links (YouTube, Google Drive, Dropbox, or direct URLs)
  ...
  - Supports YouTube (automatically embeds), Google Drive, Dropbox, and direct video links
  - Unlimited video storage (hosted on your preferred platform)
...
All data is stored in Firebase Firestore (cloud database) and syncs across all devices in real-time.

**Video Highlights**: Videos are stored externally on your chosen platform (YouTube, Google Drive, Dropbox, etc.). The database only stores the links. Recommended platforms:
- **YouTube** (unlisted videos) - Free unlimited storage, best video player
- **Google Drive** - Free 15GB storage, good for private sharing
- **Dropbox** - Free 2GB storage, easy direct links
...
3. Paste it into the player's profile
4. Videos automatically embed and play in the app
...
✅ **Video highlights** - Add YouTube, Drive, Dropbox, or direct video links  
✅ **Cloud sync** - Data shared across all devices via Firebase  
